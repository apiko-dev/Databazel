...
The source code for Databazel is made available under the [AGPL v3.0](http://www.gnu.org/licenses/agpl-3.0.html) General Public License (a commercial license is also available from [Apiko Software OU](https://jssolutionsdev.com/) ).
