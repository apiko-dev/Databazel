...
export default {
  ...
  parseToQueryObject(rawQuery, fields) {
    console.log('sql_parser parse to query Object function');
...
function getSelect(query) {
  // query.match(/^\s*select\s+([\w([\])"'`.,/\s]+)from\s/i);
...
function getHaving(query) {
  ...
  if (having) {
    ...
    console.log('parseHaveingConditions ');
    console.log(parseHaveingConditions(having));
