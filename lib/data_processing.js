...
export default {
  process(rawData, fields) {
    ...
    // console.log('process data function99999');
  ...
  othersChart(rawData, fields, chartType) {
    //
    // console.log('Others Chart function!!!!!!!!!!!!');
    // console.log('Fields ', fields);
  ...
  getStackedDatasets(rawData, labels, dimensions, measures, fields) {
    // console.log('getStackedDatasets function call !!!!!!!!!!');

    console.log('dimensions ', dimensions[0].name, dimensions[1].name);
    console.log('mesures ', measures[0].name);
